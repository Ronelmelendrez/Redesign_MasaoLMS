        ...
        >
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="https://masaolms.carsu.edu.ph/login/index.php" className="btn-outline" style={{ padding: "10px 22px", fontSize: "14px" }}>
                Log In
              </a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="mobile-menu lg:hidden px-6 pb-6 pt-2 space-y-4">
              ...
              <a href="https://masaolms.carsu.edu.ph/login/index.php" className="btn-primary block text-center mt-4" style={{ justifyContent: "center" }}>
                Log In to masaoLMS
              </a>
            </div>
          )}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-14">
                <a href="https://masaolms.carsu.edu.ph/login/index.php" className="btn-primary">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <a href="https://masaolms.carsu.edu.ph/login/index.php" className="btn-primary" style={{ background: "white", color: "var(--csu-green-dark)" }}>
